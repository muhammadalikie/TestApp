...
class MainMenuWindow(QWidget):
    def __init__(self):
        ...
        title.setStyleSheet("font-size: 46px; font-weight: bold; color: #555;")
        ...
        btn_results.setFixedSize(360, 60)
...
class LoginWindow(QWidget):
    ...
    def init_ui(self):
        ...
        title_label.setStyleSheet(
            "font-size: 46px; font-weight: bold; color: #555;")
        ...
        name_label.setStyleSheet(
            "font-size: 22px; color: #888; margin-bottom: 8px;")

        self.name_input.setFixedSize(360, 60)
        ...
        start_button.setFixedSize(360, 60)
...
class QuestionWidget(QWidget):
    ...
    def init_ui(self):
        ...
        image_label.setPixmap(
            QPixmap("./Images/Question.png").scaledToHeight(450, Qt.SmoothTransformation))
        image_label.setAlignment(Qt.AlignCenter)
        ...
        self.explanation_label.setStyleSheet(
            "font-size: 24px; color: #444; margin-top: 8px;")
...
class FinalExamStartPage(QWidget):
    ...
    def init_ui(self):
        ...
        image_label.setPixmap(QPixmap(
            "./Images/FinalExamStartPage.png").scaledToHeight(600, Qt.SmoothTransformation))
        image_label.setAlignment(Qt.AlignCenter)
...
وضعیت نهایی: {status}""")
        ...
        result_summary.setStyleSheet(
            "font-size: 24px; color: #333; margin-top: 16px;")

        btn_review = QPushButton("مرور پاسخ‌ها")
        btn_review.setFixedSize(360, 60)
...
class ReviewWindow(QWidget):
    def __init__(self, questions, user_answers):
        ...
        title.setAlignment(Qt.AlignCenter)
        title.setStyleSheet(
            "font-size: 32px; font-weight: bold; margin: 32px;")
        layout.addWidget(title)
        ...
        for i, question in enumerate(questions):
            ...
            for j, option in enumerate(question["options"]):
                label = QLabel(option)
                label.setStyleSheet(
                    "font-size: 18px; padding: 12px; border-radius: 18px;")

                if j == correct_index and j == user_index:
                    label.setText(f"✅ {option} (درست انتخاب شده)")
                    label.setStyleSheet(
                        "background-color: #A5D6A7; font-size: 18px; padding: 12px; border-radius: 18px;")
                elif j == correct_index:
                    label.setText(f"✅ {option} (پاسخ صحیح)")
                    label.setStyleSheet(
                        "background-color: #C8E6C9; font-size: 18px; padding: 12px; border-radius: 18px;")
                elif j == user_index:
                    label.setText(f"❌ {option} (پاسخ شما)")
                    label.setStyleSheet(
                        "background-color: #EF9A9A; font-size: 18px; padding: 12px; border-radius: 18px;")
                else:
                    label.setStyleSheet(
                        "background-color: #eeeeee; font-size: 18px; padding: 12px; border-radius: 18px;")
